...
/*
Given an integer N, how many numbers less than or equal N are there such that they are co-prime to N?
A number X is co-prime to N if gcd(X,N)=1.

For example, if N=10, then there are 4 numbers, namely 1,3,7,9, which are co-prime to 10.

This problem can be solved using Euler Phi Function.
*/
...
int eulerPhiSum(int n)      ///Sum of Co Prime Numbers of an Integer
{
